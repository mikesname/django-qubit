Django-Qubit is an attempt to create a Django ORM mapping for the Qubit Toolkit's data model.  The Qubit Toolkit is an
...
The intended purpose of a Django ORM mapping is to facilitate data import and export from Python-based tools.  It is not
